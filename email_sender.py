...
class EmailSender:
    ...
    def send_report(self, pdf_path: str, recipient_email: str = None) -> bool:
        ...
        try:
            # Get sender email from GMAIL_CREDENTIALS (user field) in KV Store
            # This avoids needing to call the userinfo API
            sender_email = os.getenv("SENDER_EMAIL")  
            
            if not sender_email:
                raise ValueError("SENDER_EMAIL environment variable is not set. Add 'user' field to GMAIL_CREDENTIALS in KV Store.")
